        ...
        >
          <div className="flex flex-col items-center">
            ...
            <div className="max-w-3xl">
              <h2 className="text-4xl font-bold mb-8 text-text-900 dark:text-text-50 text-center">
                About Me
              </h2>
                <p className="text-lg text-text-900 dark:text-text-200 leading-relaxed text-left">
